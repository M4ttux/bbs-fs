 ...
 * options show a green outline. Track removal stays on the keyframe sheet's RMB menu.</p>
 *
 * <p>Sizing: stock {@link UIOverlayPanel} has no content-fit hook, so {@link #preferredWidth()} /
...
public class UIShaderOptionPicker extends UIOverlayPanel
{
    ...
    public UIShaderOptionPicker(ShaderMenu menu, Map<String, String> lang, Set<String> addedOptionIds, Consumer<String> onAddOptionId, Runnable openLegacy)
    {
        ...
        this.back.tooltip(IKey.constant("Back"));
        ...
        this.legacy.tooltip(IKey.constant("Legacy list"));
    ...
    private String cellValue(ShaderMenu.Cell cell)
    {
        ...
        {
            return cell.profileName == null ? "Custom" : this.lang.getOrDefault("profile." + cell.profileName, cell.profileName);
        }
        ...
        {
            return "true".equals(cell.currentValue) ? "On" : "Off";
        }
