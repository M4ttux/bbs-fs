...
public class FormRenderLast
{
    ...
    private static void flush()
    {
        ...
        /* 1.21.1 framed the replay with enableDepthTest/enableBlend, because there the two were
         * global GL toggles a preceding draw could have left off. In 1.21.5+ both belong to the
         * pipeline each RenderLayer carries, so the replayed renderers bring their own — there is
         * no global state left here to set, and RenderSystem no longer exposes one. */
