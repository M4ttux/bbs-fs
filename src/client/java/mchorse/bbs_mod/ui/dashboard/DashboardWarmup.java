...
public class DashboardWarmup
{
     ...
     *
     * <p>1.21.11 folded {@code DownloadingTerrainScreen} into {@link LevelLoadingScreen} — the terrain
     * wait is a phase of the loading screen now, and {@code WorldEntryReason} moved onto it with the
     * rest — so the one check covers both screens 1.21.1 had.</p>
     */
