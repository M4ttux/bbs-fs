...
public class UIKeyframeDopeSheet implements IUIKeyframeGraph
{
    ...
    private void renderSheets(UIContext context, VertexConsumer builder, Matrix3x2fc matrix, Area area)
    {
        if (area.isInside(context))
        {
            for (Map.Entry<UIKeyframeSheet.Section, Integer> entry : this.sectionYCache.entrySet())
    ...
    private void renderMotionShiftBars(UIContext context, VertexConsumer builder, Matrix3x2fc matrix, Area area, UIKeyframeSheet sheet, int y, int width)
    {
    ...
    private void renderSheetsTopmostKeyframes(UIContext context, VertexConsumer builder, Matrix3x2fc matrix, Area area)
    {
        for (UIKeyframeSheet sheet : this.sheets)
        {
            if (!this.isVisible(sheet))
    ...
    private void renderSectionKeyframes(UIContext context, VertexConsumer builder, Matrix3x2fc matrix, Area area)
    {
        for (UIKeyframeSheet sheet : this.sheets)
        {
